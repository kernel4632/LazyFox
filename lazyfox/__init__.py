...
exports = {
    ...
    "TurnstileSolver": ("tools.turnstile", "TurnstileSolver"),
    "find_code": ("tools.code", "find_code"),
    "find_link": ("tools.code", "find_link"),
    "parse": ("tools.sse", "parse"),
    "parse_async": ("tools.sse", "parse_async"),
    "scan_form": ("tools.scan", "scan_form"),
    "scan_forms": ("tools.scan", "scan_forms"),
    "scan_challenge": ("tools.scan", "scan_challenge"),
    "solve_turnstile": ("tools.turnstile", "solve_turnstile"),
    "verify_turnstile": ("tools.turnstile", "verify_turnstile"),
